            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    echo "<div class=\"d-flex justify-content-between align-items-baseline\">
                        <div><h3 style=\"display:inline-block;\" class=\"mt-2 mb-3\"><a href=\"/tp2/public/pages/membre.php\" class=\"dark-link\">Espace membre</a> > Modifier le profil de ".$_SESSION['prenomSess']." ".$_SESSION['nomSess']."</h3></div>
                        <div><a href=\"/tp2/public/pages/membre.php\" class=\"btn-sm btn-warning\">Revenir en arrière</a></div>
                    </div>";
